...
其次，确保您已经下载并添加了对应引用格式的`*.csl`文件，并在YAML头部中正确设置了`csl`字段。引用格式文件可以从[CSL仓库](https://github.com/citation-style-language/styles)下载。
...
这里有两篇好文章`[@lake2011, @hale2020]` [@lake2011; @hale2020]。
